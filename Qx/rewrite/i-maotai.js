 ...
 * 环境变量：export MT_ITEM_BLACK="2478|10941"  // 申购商品ID黑名单，多个ID以 | 隔开，留空为随机申购所有商品
...
[Script]
茅台Token = type=http-request,pattern=^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query,requires-body=0,max-size=0,script-path=https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js

i 茅台 = type=cron,cronexp=17 9 * * *,timeout=60,script-path=https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js,script-update-interval=0
...
[Script]
http-request ^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query tag=茅台Token, script-path=https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js,requires-body=0

cron "17 9 * * *" script-path=https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js,tag = i 茅台,enable=true
...
[rewrite_local]
^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query url script-request-header https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js

[task_local]
17 9 * * * https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js, tag=i 茅台, enabled=true
...
script-providers:
  i 茅台:
    url: https://raw.githubusercontent.com/uniqueww/Scripts/master/Qx/rewrite/i-maotai.js
    interval: 86400
...
let MT_ITEM_BLACK = $.getdata('MT_ITEM_BLACK') || '2478|10941';
